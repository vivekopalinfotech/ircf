  ...
  Widget build(BuildContext context) {
    ...
    child: SingleChildScrollView(
      ...
      children:   [
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: AppConstants.HORIZONTAL_PADDING),
          child: Text('Indian Resuscitation Council Federation',
            textScaleFactor:1,
            style: GoogleFonts.jost(
              color: AppColor.textColor,
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: AppConstants.HORIZONTAL_PADDING),
          child: Text('IRC is an initiative by Indian Society of Anesthesiologist to promote accurate and scientific resuscitation training & guidelines.',
            textScaleFactor:1,
            style: GoogleFonts.mulish(
              color: AppColor.textColor,
              fontWeight: FontWeight.w500,
    ...
    for (int i = 0; i < filterCat.length; i++) {
      widgets.add( Card(
        ...
        child: Column(
          ...
          children: [
            Container(
              height: 134,width: MediaQuery.of(context).size.width*.72,
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        filterCat[i].name, textScaleFactor: 1,
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1,
                        style: GoogleFonts.mulish(
                            fontSize: AppConstants.XSMALL,
                      ...
                      SaveWidget(favdata: filterCat[i].isSaved,)
                    ],
                  ),
                  const SizedBox(height: 7,),
                  Text(
                    filterCat[i].title, textScaleFactor: 1,
                    overflow: TextOverflow.ellipsis,
                    maxLines: 1,
                    style: GoogleFonts.jost(
                        fontSize: AppConstants.MEDIUM,
